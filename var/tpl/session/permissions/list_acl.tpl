...
<!--	<td>
	...
	<td>
		<button onclick="javascript:session_pview_reset_matrix();">
			<img src="{link '/data/icons/22x22/add.png'}" />
	...
	<td>
		<button onclick="javascript:session_pview_send_matrix();">
			<img src="{link '/data/icons/22x22/add.png'}" />
	...
	<td>
		<button onclick="javascript:session_pview_send_user();">
			<img src="{link '/data/icons/22x22/add.png'}" />
